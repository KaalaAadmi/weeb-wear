  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-14 lg:gap-20">
            ...
            <div className="flex flex-col gap-14 lg:gap-20">
              ...
              <div className="flex flex-col md:flex-row gap-5">
                ...
                <p className="flex-1">
                  Our mission is clear: to empower brands through the
                  unparalleled power of storytelling. We believe that every
                  brand has a unique narrative waiting to be told, and our
                  mission is to bring those stories to life with authenticity,
              ...
              <div className="flex flex-col md:flex-row gap-5">
                ...
                <p className="flex-1">
                  What sets us apart is our holistic approach to video
                  production. From concept to creation and promotion, we guide
                  our clients through every step, ensuring a seamless and
                  effective process. We combine creativity with strategy,
                  producing content that not only looks stunning but also
      ...
      <section>
        ...
        <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
          {/* Component */}
          <h1 className=" md:text-7xl text-7xl font-bold flex-1 text-center mb-8">
            Our Journey
          </h1>
