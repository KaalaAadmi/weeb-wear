...
export function VariantSelector({
  ...
  const availableSizes =
    category === "poster" ? SIZE_CATEGORIES.poster : SIZE_CATEGORIES.apparel;
  ...
  useEffect(() => {
    ...
    // @ts-expect-error - TS doesn't know about the unit property
  ...
  const unavailableSizes = availableSizes.filter(
